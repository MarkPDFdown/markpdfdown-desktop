...
describe('CloudContext', () => {
  ...
  it('wraps getTasks/getTaskById/getTaskPages and task actions', async () => {
    ...
    await latestContext!.retryTask('t1', 'pro')
    await latestContext!.deleteTask('t1')
    await latestContext!.retryPage('t1', 1)
    await latestContext!.retryPage('t1', 2, 'ultra')
    ...
    expect(window.api.cloud.retryPage).toHaveBeenCalledWith({ taskId: 't1', pageNumber: 2, model: 'ultra' })
